    ...
    >
      <div className="mx-auto grid w-full max-w-6xl items-center gap-10 px-5 py-16 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-6 lg:py-24">
        <div className="relative z-10 max-w-xl">
          ...
          <h1
            id="hero-heading"
            className="font-display text-5xl font-extrabold leading-[1.05] tracking-tight text-white sm:text-6xl"
          >
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a
              href="#main"
              className="btn-solid inline-flex items-center justify-center rounded-full px-5 py-2.5 text-sm font-semibold focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white"
            >
              Get started
            </a>
